...
namespace App
{
	namespace Thread
	{
		...
		///----------------------------------------------------------------------
		///----------------------------------------------------------------------
		typedef u32(RKThreadCallback)(void* pThreadData);
...
#define RKTHREAD_EXIT RKThread_Exit();
	...
	///----------------------------------------------------------------------
		...
		bool RKThreadCondition_Sleep(RKThreadCondition* pThreadCondition, RKCriticalSection* pCriticalSection, App::DWORD time_sleep = 500);
